...
function getInfoUsers(){
  ...
  $stmt =  mysqli_prepare($conn, "SELECT FIRST_NAME,LAST_NAME,E_MAIL from FACEBOOK_USERS WHERE ID=?");
...
<html lang="en">
    ...
    <BODY>
        <form id = "Modificare_formular" class="form-horizontal" role="form" method="POST">
            ...
            <p class="text-center"> Informatiile contului sunt gata pentru actualizare!  </p>
            <hr>
